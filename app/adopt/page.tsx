          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-lg">Find your perfect companion</p>
              </div>
            </div>
      ...
      <main className="container mx-auto px-4 py-8">
          ...
          <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-xl hover:shadow-2xl transition-all duration-300">
            <CardContent className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-600">Available for Adoption</p>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      {user?.role !== 'STAFF' && user?.role !== 'ADMIN' && (
                        ...
                        >
                          ...
                          {pet.status === 'AVAILABLE' ? 'Adopt' : 'Adopted'}
                        </Button>
                      )}
                    </div>
                  </CardContent>
        ...
        <footer className="text-center py-12 text-gray-600">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl max-w-md mx-auto">
            <p className="text-lg font-medium">Ready to give a pet a loving home?</p>
            <p className="text-sm mt-2">Click on any pet to start your adoption journey</p>
          </div>
        </footer>
      </main>
    </div>
